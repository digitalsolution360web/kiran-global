...
import { ArrowRight, CheckCircle2, TrendingUp, Lightbulb, Zap, Users, ShieldCheck } from "lucide-react";
import Image from "next/image";

const benefits = [
  {
    title: "Professional Growth Opportunities",
    desc: "We provide clear career paths and opportunities to climb the leadership ladder.",
    icon: <TrendingUp className="text-secondary" size={24} />
  },
  {
    title: "Innovative Work Environment",
    desc: "Work with cutting-edge technology and processes in the industrial silicate industry.",
    icon: <Lightbulb className="text-secondary" size={24} />
  },
  {
    title: "Industry-Leading Projects",
    desc: "Technical challenges that push boundaries and define industry benchmarks.",
    icon: <Zap className="text-secondary" size={24} />
  },
  {
    title: "Employee Development",
    desc: "Continuous learning programs, workshops, and skill-upgrading sessions.",
    icon: <Users className="text-secondary" size={24} />
  },
  {
    title: "Competitive Benefits",
    desc: "Comprehensive health, wellness, and financial benefits for you and your family.",
        ...
        <div className="max-w-[1700px] mx-auto px-6 lg:px-12 relative z-10 w-full">
          ...
          >
            <div className="flex items-center gap-3 mb-6 pt-20">
              ...
              <span className="text-secondary font-bold uppercase tracking-[0.2em] text-[10px]">Join Our Mission</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black text-white leading-tight mb-8 tracking-tighter uppercase">
              Build Your Future <br />
              At <span className="text-secondary">Kiran Global</span>
            </h1>
            <p className="text-gray-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-10">
              Our people are our greatest strength. We foster a culture of innovation, transparency, collaboration, and continuous learning.
            </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            >
              ...
              <div className="absolute -bottom-8 -left-8 bg-white p-8 rounded-3xl shadow-xl border border-gray-100 hidden lg:block max-w-[280px]">
                <p className="text-2xl font-black text-primary mb-2">95%</p>
                <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Employee Satisfaction Rate</p>
              </div>
            </motion.div>
            ...
            <div className="lg:w-1/2">
              ...
              >
                ...
                <p className="text-gray-600 text-base leading-relaxed mb-12">
                  At Kiran Global, we believe in empowering our employees to take ownership and lead with innovation. We offer a collaborative environment where every voice is heard and every contribution counts towards our global goal.
                </p>
          ...
          <div className="bg-primary rounded-[3rem] p-12 lg:px-24 py-20 relative overflow-hidden text-center text-white">
            ...
            >
              ...
              <p className="text-blue-100 text-lg max-w-2xl mx-auto mb-12">
                Discover your next career move and help us shape the future of industrial silicates worldwide.
              </p>
