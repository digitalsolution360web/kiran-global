                ...
                <div className="relative z-10 max-w-[1700px] mx-auto px-6 lg:px-12 text-center lg:text-left w-full">
                    ...
                    >
                        ...
                        <h1 className="text-2xl md:text-5xl font-bold text-white mb-6 tracking-tighter">
                            M S Jain <span className="text-secondary">Group</span>
                        </h1>
                        ...
                        <p className="text-xl md:text-2xl text-white/90 max-w-3xl font-medium leading-relaxed italic">
                            "A legacy of visionary innovation and industrial excellence."
                        </p>
                    </motion.div>
                </div>
            </section>
                ...
                <div className="max-w-[1700px] mx-auto px-6 lg:px-12">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                        ...
                        <div className="lg:col-span-7 space-y-8">
                            ...
                            >
                                ...
                                <h2 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
                                    Our <span className="text-primary italic">Founding Story</span>
                                </h2>
                            ...
                            >
                                ...
                                <p className="text-lg md:text-xl text-gray-700 leading-relaxed font-semibold relative z-10">
                            ...
                            <motion.div
                                ...
                                className="space-y-6"
                            >
                                <h2 className="text-3xl md:text-4xl font-bold text-primary tracking-tighter">
                        ...
                        <div className="lg:col-span-5 space-y-8">
                            ...
                            >
                                <Image
                                    src="/Founder-Visionary.webp"
                                    alt="Founder Mr. MS Jain"
                                    fill
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 text-center">
                                    ...
                                    <p className="text-[10px] font-bold text-gray-500  tracking-widest">Mfg Units</p>
                                </div>
                                <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 text-center">
                                    <p className="text-3xl font-black text-primary mb-1">300K+</p>
                                    <p className="text-[10px] font-bold text-gray-500 tracking-widest">Tonnes / Year</p>
                                </div>
                            </div>
                        </div>
                    </div>
