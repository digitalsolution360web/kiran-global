...
import { Users, Award, Target, Briefcase, TrendingUp, Globe } from "lucide-react";
...
const leaders = [
  {
    name: "M S Jain",
    role: "Chairman",
    image: "/chairman-pic.webp",
    bio: "Founder and visionary leader of Kiran Global Chems Ltd. With decades of expertise in the chemical industry, he has guided the company to become the #1 sodium silicate manufacturer in India with a strong global presence.",
    stats: [{ label: "Experience", value: "45+ Yrs" }, { label: "Position", value: "#1 India" }],
  ...
  },
  {
    ...
    role: "Vice Chairman",
    image: "/atul.webp",
    bio: "Leading strategic growth initiatives and business expansion for Kiran Global. His leadership drives the company's global outreach, innovation pipeline, and long-term vision for sustainable industrial excellence.",
    stats: [{ label: "Focus", value: "Strategy" }, { label: "Reach", value: "45+ Nations" }],
    badge: "VICE CHAIRMAN",
  },
  {
    name: "N C Rufus",
    role: "CEO",
    image: "/rufus.webp",
    bio: "Overseeing day-to-day operations, customer success, and technology innovation across all 32 manufacturing facilities. Committed to maintaining the highest standards of quality and operational efficiency.",
    stats: [{ label: "Facilities", value: "32 Units" }, { label: "Capacity", value: "300K+ Tons" }],
        ...
        <div className="relative z-10 text-center px-6">
          ...
          >
            ...
            <p className="text-white/60 text-base font-medium max-w-xl mx-auto">
              The visionary team steering Kiran Global Chems Ltd. towards global excellence.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            {stats.map((stat, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-white/40 text-[10px] font-bold uppercase tracking-widest mt-0.5">{stat.label}</p>
                </div>
              </motion.div>
            ))}
          </div> */}
        ...
        <div className="max-w-[1700px] mx-auto px-6 lg:px-12">
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <p className="text-secondary text-[10px] font-black uppercase tracking-[0.4em]">LEADERSHIP TEAM</p>
            ...
            <div className="ml-9">
              <p className="text-gray-500 text-sm font-bold uppercase tracking-widest">
                EXECUTIVE <span className="text-gray-300">LEADERSHIP</span>
              </p>
            </div>
          </motion.div>
              ...
              >
                ...
                <div className="relative overflow-hidden rounded-2xl shadow-xl border border-gray-100 mb-6 aspect-[3/4] bg-gray-50">
                  ...
                  <div className="absolute top-4 left-4 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-2 group-hover:translate-y-0">
                    <span className="px-3 py-1.5 bg-secondary text-primary text-[9px] font-black tracking-widest uppercase rounded-full shadow-lg">
                      {leader.badge}
                    </span>
                  </div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0">
                    <div className="flex gap-4">
                      {leader.stats.map((s, si) => (
                        <div key={si} className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl px-4 py-2">
      ...
      <section className="py-20 bg-gray-50/50">
        <div className="max-w-[1700px] mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-3 gap-8">
            {[
              { icon: Target, title: "Vision-Driven", desc: "Every strategic decision is anchored in the company's long-term vision of global chemical leadership and sustainable manufacturing." },
              { icon: Users, title: "People First", desc: "Our leadership believes that a company's greatest asset is its people — fostering talent, dedication, and innovation at every level." },
              { icon: Award, title: "Quality Obsessed", desc: "From raw material sourcing to final dispatch, the management ensures uncompromising adherence to global quality and safety standards." },
            ].map((val, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 24 }}
